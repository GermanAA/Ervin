...
<body>
    ...
    <div class="container-fluid text-center">
        ...
        <div class="row justify-content">
            ...
            <div class="col-sm-12">
            <h2 class="">Aviso de Privacidad</h2>

            <p class="">TractoElite, con domicilio en CDMX, México, es responsable del tratamiento de los datos personales que usted nos proporcione, los cuales serán protegidos conforme a lo dispuesto por la Ley Federal de Protección de Datos Personales en Posesión de los Particulares.</p>

            <h3>1. Finalidad del tratamiento de datos</h2>
                ...
                <p>Tú, como titular de los datos, puedes ejercer en cualquier momento tus derechos de Acceso, Rectificación, Cancelación u Oposición (ARCO) mediante una solicitud al correo:
                    <a href="mailto:contacto@clean-up.mx">ventas@tractoelite.com</a>
                </p>
                ...
                <p>Este aviso puede ser actualizado en cualquier momento. Te recomendamos revisarlo periódicamente en nuestro sitio web:
                    <a href="https://tractoelite.com" target="_blank">https://tractoelite.com/</a>
                </p>
        </div>
    </div>
